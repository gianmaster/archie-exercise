import { ExternalLinkIcon, LinkIcon, TimeIcon } from '@chakra-ui/icons';
import {
  Box,
  Image,
  Link,
...
function MissionCard({ data }: MissionCardProps) {
      ...
      <Box>
        <Box p="2" px="4">
          ...
          >
            <Popover>
              <PopoverTrigger>
                <Text noOfLines={4} cursor="pointer">
                  {data.description}
                </Text>
              </PopoverTrigger>
              <PopoverContent>
          ...
          <Box>
            ...
            >
              {twitter && (
                <Tooltip label="Twitter account">
                  <Link href={twitter} isExternal color="blue.400">
                    <TwitterIcon />
                  </Link>
                </Tooltip>
              )}
              ...
              {website && (
                <Tooltip label="Go to website">
                  <Link href={website} isExternal color="teal.500">
                    Site
                  </Link>
                </Tooltip>
              )}
              ...
              {wikipedia && (
                <Tooltip label="Go to the wiki page">
                  <Link href={wikipedia} isExternal color="blue.400">
                    Wiki
                  </Link>
                </Tooltip>
              )}
